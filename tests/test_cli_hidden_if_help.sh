...
setup() {
    ...
    knit_register "hih_plain" knit_empty "A plain command."
    knit_done
    knit_register "hih_dyn" knit_empty "A dynamically hidden command."
    knit_hidden_if _hih_yes
    knit_done
    knit_register "hih_show" knit_empty "A shown command."
    knit_hidden_if _hih_no
    knit_done
    knit_register "hih_static" knit_empty "A statically hidden command."
    knit_hidden
    knit_done
}
...
@test "_knit_provenance_enabled ignores a dynamic hide (keys off _is_hidden)" {
    ...
    knit_register "hih_prov" knit_empty "A command."
...
@test "_knit_provenance_enabled treats a statically hidden command as transparent" {
    knit_register "hih_prov_static" knit_empty "A command."
    knit_with_table "id:string"
    knit_hidden
    knit_done
